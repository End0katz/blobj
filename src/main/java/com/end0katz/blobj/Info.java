    ...
    public static String classToString(Class<?> cls) {
        if (cls == null) {
            ...
            if (cls.getCanonicalName() == null) {
                ...
                for (String s : cls.getPackage().getName().substring("java.lang.".length()).split("\\.")) {
                ...
                StringBuilder result = new StringBuilder(pkg.getFirst());

                for (String s : pkg.subList(1, pkg.size() - 1)) {
